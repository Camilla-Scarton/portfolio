  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} whileInView={{ opacity: 1 }} className="mt-4 text-secondary sm:text-[24px] text-[18px] mx-w-3xl leading-[30px] cursor-default">
        Passionate about web development, I have honed my JavaScript skills through 400+ Codewars exercises and consistent practise. I'm proficient in React, mastered at Develhope, and adept in Angular through my professional journey. As a hobby, I collect certificates!
      </motion.p>
